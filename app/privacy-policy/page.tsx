      ...
      <div ref={bodyRef} className={`content-block flex-module fadeIn wow${bodyVis}`}>
        <div className="inner inner--slim-1172">
          <div className={`content-entry fadeInUpS wow${bodyVis}`} style={{ animationDelay: "0.1s", maxWidth: "72rem" }}>
            ...
            <p>
              Top HVAC NYC (&ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;) operates this website
            ...
            <ul>
              ...
              <li>Call us directly at (646) 493-4904</li>
            ...
            <p>
              <strong>Top HVAC NYC</strong><br />
              Manhattan, New York, NY<br />
              Phone: <a href="tel:6464934904">(646) 493-4904</a>
            </p>
